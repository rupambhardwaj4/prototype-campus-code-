...
const sampleContests = [
    { id: 1, name: "Weekly Algorithm Challenge", type: "competition", faculty: "Dr. Smith", subject: "DBMS", section: "A", duration: "3 hours", startDate: "2026-02-01", startTime: "10:00", endTime: "13:00", status: "pending", participants: 45, maxParticipants: 100 },
    { id: 2, name: "SQL Mastery Test", type: "assessment", faculty: "Prof. Brown", subject: "DBMS", section: "B", duration: "2 hours", startDate: "2026-01-28", startTime: "14:00", endTime: "16:00", status: "approved", participants: 32, maxParticipants: 50 },
    { id: 3, name: "OS Fundamentals Quiz", type: "practice", faculty: "Dr. Miller", subject: "DBMS", section: "A", duration: "1 hour", startDate: "2026-02-05", startTime: "11:00", endTime: "12:00", status: "pending", participants: 28, maxParticipants: 75 },
    { id: 4, name: "Network Programming Contest", type: "competition", faculty: "Prof. White", subject: "DBMS", section: "C", duration: "4 hours", startDate: "2026-02-10", startTime: "09:00", endTime: "13:00", status: "approved", participants: 52, maxParticipants: 80 },
    { id: 5, name: "Data Structures Sprint", type: "practice", faculty: "Dr. Clark", subject: "DBMS", section: "B", duration: "2 hours", startDate: "2026-01-30", startTime: "10:00", endTime: "12:00", status: "active", participants: 67, maxParticipants: 100 },
    { id: 6, name: "OOPS Concepts Test", type: "assessment", faculty: "Dr. Lee", subject: "DBMS", section: "A", duration: "1.5 hours", startDate: "2026-02-03", startTime: "15:00", endTime: "16:30", status: "pending", participants: 38, maxParticipants: 60 },
    { id: 7, name: "MongoDB Challenge", type: "competition", faculty: "Prof. Brown", subject: "DBMS", section: "A", duration: "3 hours", startDate: "2026-02-08", startTime: "10:00", endTime: "13:00", status: "approved", participants: 41, maxParticipants: 70 },
    { id: 8, name: " Advanced Algorithms", type: "practice", faculty: "Dr. Smith", subject: "DBMS", section: "A", duration: "2.5 hours", startDate: "2026-02-12", startTime: "14:00", endTime: "16:30", status: "pending", participants: 55, maxParticipants: 90 },
    // CONFLICT EXAMPLE: Same subject (DBMS), Same section (A), Same time (10:00-13:00), Same date (2026-02-01)
    { id: 9, name: "DBMS Speed Challenge", type: "competition", faculty: "Dr. Davis", subject: "DBMS", section: "A", duration: "3 hours", startDate: "2026-02-01", startTime: "10:00", endTime: "13:00", status: "pending", participants: 42, maxParticipants: 80 },
];
